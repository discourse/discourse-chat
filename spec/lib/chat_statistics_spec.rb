...
describe DiscourseChat::Statistics do
  ...
  fab!(:channel1) do
    Fabricate(:chat_channel, created_at: minus_time(1.hour))
  end
  ...
  fab!(:membership1) { Fabricate(:user_chat_channel_membership, user: user1, chat_channel: channel1) }
  fab!(:membership2) { Fabricate(:user_chat_channel_membership, user: user2, chat_channel: channel1) }
  fab!(:membership3) { Fabricate(:user_chat_channel_membership, user: user3, chat_channel: channel1) }

  fab!(:message1) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(5.minutes), user: user1) }
  fab!(:message2) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(2.days), user: user2) }
  fab!(:message3) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(6.days), user: user2) }
  fab!(:message4) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(11.days), user: user2) }
  fab!(:message5) { Fabricate(:chat_message, chat_channel: channel4, created_at: minus_time(12.days), user: user3) }
  fab!(:message6) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(13.days), user: user2) }
  fab!(:message7) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(16.days), user: user1) }
  fab!(:message8) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(42.days), user: user3) }
  fab!(:message9) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(42.days), user: user3, deleted_at: minus_time(10.days), deleted_by: user3) }
  fab!(:message10) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(50.days), user: user4) }
  fab!(:message10) { Fabricate(:chat_message, chat_channel: channel1, created_at: minus_time(62.days), user: user4) }
